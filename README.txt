...
How to play:
  ...
  How the game works: 3 different types of enemies will either fall down towards you or shoot at you.
	...
	between each spawn of each enemy type is shortened. Also every 30 seconds, a random collectable will spawn.
  ...
  More: You can see not only yours, but also enemies' health bars. Enemies and collectables will spawn in the left, middle, right, or
